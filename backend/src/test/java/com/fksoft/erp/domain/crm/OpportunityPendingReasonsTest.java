 ...
 * the fixed, pre-defined reason codes (the staleness window is 14 days; "stuck" is measured from the creation
 * date). The Opportunity is mocked to control its stage/dates independently of the persistence lifecycle.
 */
class OpportunityPendingReasonsTest {
    ...
    void oldWithNoRecentActivityIsWithoutRecentActivity() {
        ...
        assertThat(OpportunityPendingReasons.of(o, NOW, TODAY, null)).containsExactly("WITHOUT_RECENT_ACTIVITY");
    }
    ...
    void overdueNextActionIsPending() {
        ...
        assertThat(OpportunityPendingReasons.of(o, NOW, TODAY, null)).containsExactly("OVERDUE_NEXT_ACTION");
    }
    ...
    void readyForProposalIsPending() {
        ...
        assertThat(OpportunityPendingReasons.of(o, NOW, TODAY, RECENT)).containsExactly("READY_FOR_PROPOSAL");
    }

    @Test
    void expectedCloseInThePastIsPending() {
        Opportunity o = opportunity(OpportunityStage.PRODUCT_FIT, RECENT, null, TODAY.minusDays(1));
        assertThat(OpportunityPendingReasons.of(o, NOW, TODAY, null)).containsExactly("EXPECTED_CLOSE_OVERDUE");
    }
