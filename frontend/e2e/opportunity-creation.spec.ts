...
test('creates a commercial opportunity from a qualified lead', async ({ page }) => {
  await login(page);
  ...
  // Open the detail, log an effective contact (NEW -> Contacted), then qualify.
  ...
  // The qualified lead can now originate an Opportunity.
